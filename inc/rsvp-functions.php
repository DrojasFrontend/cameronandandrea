...
function configurar_smtp($phpmailer) {
    ...
    $phpmailer->FromName = 'Cameron & Andrea\'s Wedding';
}
...
function sendAdminEmail($guest_name, $guests, $allergies, $email) {
    ...
    $message .= '
        ...
        <div class="footer">
            ...
            <p>Cameron & Andrea\'s Wedding - January 16th, 2026 - Cartagena, Colombia</p>
        </div>
    </body>
    </html>';
...
function sendGuestEmail($guest_name, $email) {
    $subject = '💌 RSVP Confirmation - Cameron & Andrea\'s Wedding';
    ...
    <body>
        <div class="container">
            ...
            <div class="footer">
                ...
                <p>With love,</p>
                <p><strong>Cameron & Andrea</strong></p>
