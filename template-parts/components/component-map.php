    ...
    <div class="position-relative">
        ...
        <div class="position-xl-absolute top-0 start-0 w-100 h-100 d-flex align-items-end">
            <div class="container bg-white">
                <div class="row py-xl-5 py-xl-3 p-3">
                    ...
                    <div class="col-12 col-xl-3 border-right px-4">
                        <div class="d-flex flex-column justify-content-center h-100">
                            ...
                            <p class="fs-p-big fs-6-small text-primary">INTERNATIONAL AIRPORT</p>
                            <p class="fs-p-xsmall fs-6-small text-primary mb-xl-0 mb-xl-4 mb-2">CARTAGENA, COLOMBIA</p>
                        </div>
                    </div>
                    <div class="col-12 col-xl-8 ps-4">
                        <p class="fs-p-medium fs-8 text-primary py-1">
